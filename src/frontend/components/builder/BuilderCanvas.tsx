...
export default function BuilderCanvas({
  ...
  return (
    <div className="builder-canvas-bg builder-scroll h-full w-full overflow-y-auto overscroll-contain">
        ...
        {device === 'mobile' ? (
          <div className="mx-auto w-[390px] max-w-full shrink-0">
            <div className="rounded-[2.5rem] border-[6px] border-slate-900 bg-slate-900 p-2 shadow-2xl">
              <div
                className="builder-scroll h-[min(720px,calc(100dvh-230px))] overflow-y-auto overscroll-contain rounded-[2rem] bg-white"
          ...
          <div className="w-full max-w-[900px] shrink-0">
            <div className="overflow-hidden rounded-2xl border bg-white shadow-2xl">
              ...
              <div
                className="builder-scroll h-[min(780px,calc(100dvh-240px))] overflow-y-auto overscroll-contain"
