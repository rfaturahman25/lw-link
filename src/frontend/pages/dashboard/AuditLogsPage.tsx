  ...
  return (
    <div className="space-y-4">
      ...
      <p className="text-sm text-muted-foreground">
        Sensitive actions — SUPER_ADMIN only • {logs.length} entries
      </p>
            ...
            <tbody>
              {logs.map((l) => (
                <tr key={l.id} className="border-b last:border-0 hover:bg-muted/20">
                  ...
                  <td className="px-4 py-2">
                    <span className="inline-flex rounded bg-muted px-2 py-1 text-xs font-mono">
                      {l.action}
                    </span>
                  </td>
                  ...
                  <td className="px-4 py-2 hidden md:table-cell text-xs text-muted-foreground max-w-[200px] truncate">
                    {l.details || '—'}
                  </td>
